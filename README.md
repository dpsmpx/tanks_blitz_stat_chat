...
Полупрозрачный оверлей поверх игры показывает статистику текущей сессии, а вы управляете им голосом — не отрываясь от боя. После каждого боя называете урон и исход, программа сама считает винрейт, средний и лучший урон, ведёт историю по сессиям и танкам.
